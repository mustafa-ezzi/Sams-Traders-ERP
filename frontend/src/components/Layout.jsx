  ...
  },
  {
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          {
            to: "/reports/inventory/stock-quantity",
...
const pageTitles = {
  ...
  "/reports/sales": { title: "Sales Summary", eyebrow: "Reports" },
  "/reports/sales/invoices": { title: "Sales by Invoice", eyebrow: "Reports" },
  "/reports/sales/by-product": { title: "Sales by Product", eyebrow: "Reports" },
  "/reports/sales/monthly": { title: "Monthly Sales Trend", eyebrow: "Reports" },
  "/reports/sales/by-customer": { title: "Sales by Customer", eyebrow: "Reports" },
  "/reports/sales/by-salesman": { title: "Sales by Salesman", eyebrow: "Reports" },
  "/reports/sales/by-warehouse": { title: "Sales by Warehouse", eyebrow: "Reports" },
  "/reports/sales/by-dimension": { title: "Sales by Dimension", eyebrow: "Reports" },
  "/reports/sales/returns": { title: "Sales Returns", eyebrow: "Reports" },
  "/reports/sales/receipts": { title: "Sales Receipts", eyebrow: "Reports" },
  "/reports/salesman": { title: "Salesman Performance", eyebrow: "Reports" },
  "/reports/inventory/stock-quantity": {
    title: "Stock by Quantity",
    eyebrow: "Reports",
  },
  "/reports/inventory/stock-valuation": {
    title: "Stock by Valuation",
    eyebrow: "Reports",
  },
