              ...
              <tbody>
                {(preview.material_requirements || []).map((item) => (
                  ...
                  >
                    ...
                    <td
                      className={`px-3 py-2 font-semibold ${Number(item.available_quantity) >= Number(item.required_quantity) ? "text-emerald-700" : "text-rose-700"}`}
                    >
              ...
              <tbody>
                {records.map((row) => (
                  ...
                  >
                    ...
                    <td
                      className={`px-5 py-4 font-semibold ${Number(row.quantity) >= 0 ? "text-emerald-700" : "text-rose-700"}`}
                    >
