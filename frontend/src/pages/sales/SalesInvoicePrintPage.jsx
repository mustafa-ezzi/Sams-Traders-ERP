...
const SalesInvoicePrintPage = () => {
  ...
  return (
    <>
      ...
      <div className="si-print-page min-h-full bg-slate-100">
        <div className="si-print-toolbar sticky top-0 z-10 flex items-center justify-between gap-3 border-b border-slate-200 bg-white px-4 py-3 shadow-sm">
...
export default SalesInvoicePrintPage;
